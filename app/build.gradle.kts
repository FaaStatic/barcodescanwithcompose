...
android {
    namespace = "com.techtest.caseone"
    compileSdk = 34
...
dependencies {
    ...
    ksp("com.google.dagger:dagger-compiler:$hilt_dagger_version")
    ksp("com.google.dagger:hilt-compiler:$hilt_dagger_version")
